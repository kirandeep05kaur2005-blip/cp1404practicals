...
# ✅ TODO 3: list comprehension to create a list of only the numbers that are greater than 9
# from the numbers (not strings) you just created
greater_than_nine = [num for num in numbers if num > 9]
print(greater_than_nine)

# ✅ TODO 4: use a list comprehension and the join string method to create a string
# of the last names for those full names longer than 11 characters
# Expected result: 'Harlem, Hendrix, Lovelace'
